...
Game play is fairly simple:
  ...
  * Game starts with 1 Corgi on the top bar, while the other one staying down at the seasaw.
  ...
  * When ready to grab energy items, user will perform a click (or press spacebar) and the top Corgi will jump down. Landing on the seasaw will result in the other Corgi jumping back up, landing on the top bar.
